        ...
        value: function render() {
          ...
          if (displayMode === "dateRange" && drag.status) {
            ...
            ranges = ranges.map(function(range, i2) {
              if (i2 !== focusedRange[0]) return range;
...
var require_react_list = __commonJS({
  "node_modules/react-list/react-list.js"(exports) {
    (function(global, factory) {
      ...
      function _classCallCheck2(a3, n) {
        if (!(a3 instanceof n)) throw new TypeError("Cannot call a class as a function");
      }
      ...
      function _createClass2(e2, r, t2) {
        return r && _defineProperties2(e2.prototype, r), t2 && _defineProperties2(e2, t2), Object.defineProperty(e2, "prototype", { writable: false }), e2;
      }
      function _callSuper(t2, o, e2) {
        return o = _getPrototypeOf2(o), _possibleConstructorReturn2(t2, _isNativeReflectConstruct2() ? Reflect.construct(o, e2 || [], _getPrototypeOf2(t2).constructor) : o.apply(t2, e2));
      }
      ...
      var isEqualSubset = function isEqualSubset2(a3, b2) {
        for (var key in b2) if (a3[key] !== b2[key]) return false;
        return true;
      };
      ...
      var ReactList = _exports["default"] = (function(_Component) {
        function ReactList2(props) {
          var _this;
          _classCallCheck2(this, ReactList2);
        ...
        _inherits2(ReactList2, _Component);
        return _createClass2(ReactList2, [{
          ...
          value: function maybeSetState(b2, cb) {
            if (isEqualSubset(this.state, b2)) return cb();
            this.setState(b2, cb);
          }
        }, {
          ...
          value: function scrollAround(index) {
            ...
            if (current <= min2) return this.setScroll(min2);
            if (current > max2) return this.setScroll(max2);
          }
        }, {
          key: "getVisibleRange",
          value: function getVisibleRange() {
            ...
            for (var i2 = from; i2 < from + size; ++i2) {
              ...
              if (first == null && itemEnd > start) first = i2;
              if (first != null && itemStart < end) last = i2;
            }
            return [first, last];
          }
        }, {
          ...
          value: function renderItems() {
            ...
            var items = [];
            for (var i2 = 0; i2 < size; ++i2) items.push(itemRenderer(from + i2, i2));
      ...
      _defineProperty2(ReactList, "displayName", "ReactList");
      _defineProperty2(ReactList, "defaultProps", {
        axis: "y",
  ...
  "node_modules/react-date-range/dist/components/Calendar/index.js"(exports) {
    ...
    var Calendar = (function(_PureComponent) {
      ...
      function Calendar2(_props, context) {
        ...
        if (_props.weekStartsOn !== void 0) _this.dateOptions.weekStartsOn = _props.weekStartsOn;
